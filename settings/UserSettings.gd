...
const KEYBOARD_LAYOUT = "keyboard_layout"
...
func _ready():
	...
	Nodes.keyboard.set_layout(get_value_with_default(KEYBOARD_LAYOUT, USER_SETTING_DEFAULTS[KEYBOARD_LAYOUT]))
...
func set_value(key, value):
	...
	if key == KEYBOARD_LAYOUT and Nodes.keyboard:
		Nodes.keyboard.set_layout(value)
